...
class ServiceProviderGenerator
{
    ...
    public function __construct(Container $container)
    {
        ...
        $this->loggerFactory = LoggerFactory::system("generator", "service_provider", false);
    }
    ...
    public function generate(string $name, array $options = []): array
    {
        ...
        $this->loggerFactory->info("Service provider '{$name}' generated successfully.", [
            'provider_file' => $providerFile,
            'config_file' => $withConfig ? $configFile : null,
        ]);
