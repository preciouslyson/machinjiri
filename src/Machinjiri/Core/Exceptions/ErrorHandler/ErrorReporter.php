...
<div class="container">
    ...
    <div class="details">
        <strong>Exception class: {$class}</strong><br>
    ...
    <div class="details">
        <strong>URI: </strong> {$request->getMethod()} {$request->getUri()}<br>
        <strong>Request:</strong> {$method} {$uri}<br>
        <strong>IP:</strong> {$ip}
        <strong>User Agent: </strong> {$request->getServerParam("HTTP_USER_AGENT")}<br>
