...
<head>
    ...
    <title>$appName - Caught Error</title>
    <style>
        :root {
            --primary: #6f42c1;
            --secondary: #20c997;
  ...
  <div class="main">
    <div class="error-container">
        <div class="error-header">
          ...
          <span class="error-type">Caught Error - #$errorCode</span>
        </div>
        ...
        <div class="error-body">
          <div class="error-detail">
            ...
            <span class="error-value">$errorFile <small style="font-weight: 700;">on line $errorLine</small></span>
          </div>
        </div>
HTML;
